 ...
 *
 * <p>Every number in here can be checked by hand at the review, which is the
 * point: 86400 seconds in a day, at most 25 symbols a request, 2000 requests a
 * key a day, 200 of them held back for orders.
 */
class PollScheduleTest {
    ...
    class ComputedFloor {
        ...
        void twentySixSymbolsRaiseTheFloorAboveSixty() {
            ...
            // A hard-coded floor of 60 would spend 2880 and lose the key --
            // this is the case that makes the floor arithmetic rather than a
        ...
        void requiredIntervalRoundsUp() {
            // 86400 / 1800 is exactly 48 for one call. Make the budget awkward
            // and the division stops being exact: 86400 / 700 = 123.43, and
            // 123s would spend 702 requests, which is over.
