...
/**
 * One row of {@link ExecutionMapper#findOrder}: the order joined to the facts
 * about its instrument that the checks need.
 *
 * <p>A mutable bean rather than a record because MyBatis maps columns through
 * setters. It is turned into domain types at the edge, in {@link RowMapping},
 * so nothing past this package handles a bean with a half-populated shape.
 */
