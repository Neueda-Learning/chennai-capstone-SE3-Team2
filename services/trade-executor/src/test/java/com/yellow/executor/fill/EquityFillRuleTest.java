...
/**
 * The fill rule at its boundaries. Most of these tests sit on the exact edge,
 * because that is where a fill rule is either right or quietly wrong.
 */
class EquityFillRuleTest {
    ...
    class Buys {
        ...
        void limitAtLastTradedPriceIsRejected() {
            // The trap this rule exists to avoid. 48.
