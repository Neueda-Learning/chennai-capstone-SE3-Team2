...
public class OrderService {
    ...
    public OrderResponse placeOrder(PlaceOrderRequest request) {
        ...
        // Sprint 7: reserve the cash this order commits. The domain has just
        // checked rule 6 against availableFunds, which is balance minus
    ...
    public OrderResponse cancelOrder(UUID orderId) {
        ...
        if (existing == null) {
            ...
            // because the catalogue has no ORD-404.
        ...
        // Sprint 7: give the reservation back. AFTER the conditional update
        // and only when it reported one row.
