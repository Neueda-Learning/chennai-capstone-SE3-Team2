...
class TradeApiIntegrationTest extends PostgresSupport {
    ...
    void orderReachesTheDatabase() {
        ...
        // lock, at the price the order actually executed at.
    ...
    void aNewOrderCancelsAndASecondCancelIsRefused() {
        ...
        // predicted this rewrite: Sprint 6 filled inside the request, so
        ...
        // And the reservation came back. 00 on top of the seeded 220,000;
        // cancelling returns it, so the account is exactly where it started.
    ...
    void concurrentBuysAreSerialisedByTheVersionColumn() throws Exception {
        // Sprint 6 proved the optimistic lock here by debiting cash inside
        // the request.
        int attempts = 8;
        ...
        // Exactly one. 75; only one of them wins the conditional update, and
        // the other seven get ORD-409.
