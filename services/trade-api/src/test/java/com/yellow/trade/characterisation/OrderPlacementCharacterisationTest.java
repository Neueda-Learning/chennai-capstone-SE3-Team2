...
class OrderPlacementCharacterisationTest extends PostgresSupport {
    ...
    void acceptedOrderWritesRowCashAndPosition() {
        ...
        // behaviour: the order was written FILLED, 14,500 was debited and
        ...
        // REPINNED AGAIN IN SPRINT 7, second change, and for a different
        // reason from the first. The first repin recorded that placement
        ...
        // 00 = 14,500 reserved at the LIMIT price, on top of the 220,000 the
        // seed already holds. The limit, not a fill price: this order has
