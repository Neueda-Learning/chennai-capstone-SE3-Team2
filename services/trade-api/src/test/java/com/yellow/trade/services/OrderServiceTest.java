...
class OrderServiceTest {
    ...
    void buyIsPlacedWithoutMovingCashOrPosition() {
        ...
        // But the notional IS reserved, at the LIMIT price and the version
        // we read. Not debited -- the money is still the customer's -- just
    ...
    void placeOrderFailsWhenTheAccountMovedUnderIt() {
        ...
        // against a balance that no longer holds.
    ...
    void sellReservesNothing() {
        ...
        // Reserving the HOLDING would be the equivalent mechanism for a
        // sell, and this schema has no column for it.
    ...
    void aLostCancelReleasesNothing() {
        ...
        // This is what keeps the release exactly-once. Two concurrent
        // cancels both read NEW; only one moves the row, and only that one
